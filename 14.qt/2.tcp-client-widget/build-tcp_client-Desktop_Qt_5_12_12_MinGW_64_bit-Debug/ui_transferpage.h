...
public:
    ...
    void setupUi(QWidget *transferPage)
    {
        ...
        textedit_output_2 = new QTextEdit(transferPage);
        textedit_output_2->setObjectName(QString::fromUtf8("textedit_output_2"));

        gridLayout_4->addWidget(textedit_output_2, 0, 0, 4, 1);
